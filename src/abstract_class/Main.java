...
//        System.out.println("Delete device " + Arrays.toString(laptop.getAllDevice()));
        ...
        Device phone0 = new Phone1(1, "MI", 13000, "Android 10", "Black",
                LocalDate.of(2022, 3, 29), "8 Mp", false);
        Device phone1 = new Phone1(2, "Redmi", 15000, "Android 9", "Blue",
                LocalDate.of(2023, 5, 9), "13 Mp", true);

        phone0.addDevice(phone0);
        phone0.addDevice(phone1);
        System.out.println("All device " + Arrays.toString(phone0.getAllDevice()));
//        System.out.println("\n" + phone.getById(1));

        phone0.updateDevice(1, new Phone1(1, "Honor", 14000, "Android", "red",
                LocalDate.of(2021, 10, 10), "9 Mp", false));
//        System.out.println("Update device " + Arrays.toString(phone.getAllDevice()));

        phone0.deleteDevice(1);
        System.out.println("Delete device " + Arrays.toString(phone0.getAllDevice()));
